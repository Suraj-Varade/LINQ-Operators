    ...
    public class Employee
    {
        ...
        public static List<Employee> GetAllEmployees()
        {
            return new List<Employee>() {
                ...
                new Employee(){  ID = 6 , Name = "Velarie" , Gender = "Female", Department = "HR", Salary = 70000},
                new Employee(){  ID = 7 , Name = "John" , Gender = "Male", Department = "IT", Salary = 64000},
                new Employee(){  ID = 8 , Name = "Pam" , Gender = "Female", Department = "IT", Salary = 54000},
                new Employee(){  ID = 9 , Name = "Stacey" , Gender = "Female", Department = "HR", Salary = 84000},
